...
if __name__ == '__main__':
    ...
    # npz_to_txt(dataset_dir)
    # generate_record(dataset_dir)
    # csv_generator = CsvGenerator(dataset_dir)
    # csv_generator.unbiased_split(skew_splits=[0.8, 0.2], temporal_splits=None, sample_type='activity')
